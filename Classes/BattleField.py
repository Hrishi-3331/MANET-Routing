...
class BattleField:
    ...
    def create_soldiers(self):
        ...
        while i < self.soldier_count:
            random_latitude = self.lat + random.randint(1, 9)*0.0001 + random.randint(1, 9)*0.00001 + random.randint(1, 9)*0.000001
            random_longitude = self.lon + random.randint(1, 9)*0.0001 + random.randint(1, 9)*0.00001 + random.randint(1, 9)*0.000001
